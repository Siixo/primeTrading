...
<template>
  <div>
    <div class="relative h-screen w-full">
      <img
        src="/imgs/andreas-brucker-C2Dyr5FhGPQ-unsplash.jpg"
      ...
      >
        ...
        <button
          class="px-6 py-3 bg-white text-black font-semibold rounded-full hover:bg-neutral-200 transition"
        >
          Get Started
        </button>
      </div>
    ...
    <div class="h-96 bg-gray-100 flex items-center justify-center">
      <p class="text-gray-600">Scroll up to see the header appear</p>
    </div>
  </div>
</template>
